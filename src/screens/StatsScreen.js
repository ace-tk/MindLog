  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#000' }}>
      ...
      >
        ...
        {/* Correlation Section */}
        {insights.correlation && (insights.correlation.bestTag || insights.correlation.worstTag) && (
          <View style={styles.correlationContainer}>
            <Text style={styles.sectionTitle}>Hidden Patterns</Text>
            {insights.correlation.bestTag && (
              <View style={styles.correlationCard}>
                <Ionicons name="trending-up" size={24} color="#00E676" />
                <Text style={styles.correlationText}>
                  You tend to feel better when you tag <Text style={{ fontWeight: 'bold', color: '#00E676' }}>{insights.correlation.bestTag}</Text>.
                </Text>
              </View>
            )}
            {insights.correlation.worstTag && (
              <View style={[styles.correlationCard, { marginTop: 10 }]}>
                <Ionicons name="trending-down" size={24} color="#FF5252" />
                <Text style={styles.correlationText}>
                  You tend to feel lower when you tag <Text style={{ fontWeight: 'bold', color: '#FF5252' }}>{insights.correlation.worstTag}</Text>.
                </Text>
              </View>
            )}
          </View>
      ...
      <BottomTabBar navigation={navigation} activeTab="Stats" />
    </View>
  );
}
